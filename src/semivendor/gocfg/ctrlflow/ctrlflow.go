...
var Analyzer = &analysis.Analyzer{
	...
	FactTypes:  []analysis.Fact{new(noReturn2)},
	Requires:   []*analysis.Analyzer{inspect.Analyzer},
}

// noReturn2 is a fact indicating that a function does not return.
type noReturn2 struct{}

func (*noReturn2) AFact() {}

func (*noReturn2) String() string { return "noReturn" }
...
func (c *CFGs) buildDecl(fn *types.Func, di *declInfo) {
	...
	if !di.started { // break cycle
		...
		if di.noReturn {
			c.pass.ExportObjectFact(fn, new(noReturn2))
		}
...
func (c *CFGs) callMayReturn(call *ast.CallExpr) (r bool) {
	...
	return !c.pass.ImportObjectFact(fn, new(noReturn2))
}
